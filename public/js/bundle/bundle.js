  ...
  addKecelakaanForm.addEventListener('submit', function (e) {
    ...
    if (addKecelakaanForm.checkValidity()) {
      ...
      (0, _manageData.addNewData)(modelName, {
        ...
        user_id: user_id
      }, addKecelakaanForm, bsAddDataModal);
    }
  });
}
