...
exports.replaceClustering = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var _deleteClustering = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/clustering/user/".concat(userId)
          });
        case 3:
          _context.next = 8;
          break;
  ...
  return function _deleteClustering(_x) {
    return _ref.apply(this, arguments);
  };
}();
var _getCuaca = function _getCuaca() {};
var _addClustering = /*#__PURE__*/function () {
  ...
  return function _addClustering(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var _addClusteringResult = function _addClusteringResult() {};
var replaceClustering = exports.replaceClustering = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, form) {
    var addClusteringResult;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _addClustering(data);
        case 2:
          addClusteringResult = _context3.sent;
          if (addClusteringResult !== 'success') {
            form.classList.remove('was-validated');
            (0, _alert.validationErrorAlert)(addClusteringResult);
          } else {
  ...
  return function replaceClustering(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
