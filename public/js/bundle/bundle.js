...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, form) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)(_context.t0.response.data.message, 'danger');
        case 11:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"manage-data.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateDataById = exports.importData = exports.delDataById = exports.delAllDataByUserId = exports.addNewData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            modal.hide();
            (0, _alert.delayAlert)("Data ".concat(modelName, " has been added successfully"), 'success');
          }
          _context.next = 11;
          break;
        case 7:
...
var delAllDataByUserId = exports.delAllDataByUserId = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(modelName, userId, modal) {
...
var importData = exports.importData = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(modelName, data, form, modal) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/api/v1/".concat(modelName, "/many"),
            data: data
          });
        case 3:
          res = _context5.sent;
          if (res.data.status === 'success') {
            modal.hide();
            (0, _alert.delayAlert)("Data ".concat(modelName, " has been imported successfully"), 'success');
          }
          _context5.next = 11;
          break;
        case 7:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"clustering.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var _kMeansClustering = function _kMeansClustering(dataset, k) {
  k *= 1; //? Convert k to number type
  var ids = ['clustering_id', 'cuaca_id'];
  dataset.forEach(function (data) {
    var randomNumber = Math.floor(Math.random() * k) + 1;
    data.cluster = "cluster_".concat(randomNumber);
  });
  return dataset;
};
var _addClustering = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", res.data.data.clustering);
        case 6:
          _context.next = 12;
          break;
        case 8:
  ...
  return function _addClustering(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var _addClusteringResult = /*#__PURE__*/function () {
  ...
  return function _addClusteringResult(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
var _getCuaca = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/cuaca/user/".concat(userId)
          });
        case 3:
          res = _context3.sent;
          if (!(res.data.status === 'success')) {
          ...
          return _context3.abrupt("return", res.data.data.cuacas);
        case 6:
          _context3.next = 11;
          break;
        case 8:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          filteredCuacaArr = cuacaArr.map(function (cuaca) {
            var obj = {};
          ...
          filteredClusteringResult = kMeansResult.map(function (clusteringResult) {
            var obj = {};
            clusteringResultFilter.forEach(function (el) {
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    if (loginForm.checkValidity()) {
      ...
      (0, _auth.login)(email, password, loginForm);
    }
  });
}
...
if (cuacaTable) {
  ...
  new _simpleDatatables.DataTable(cuacaTable, cuacaTableOptions);
}

//? Add Data
if (addCuacaForm) {
  inputData = ['user_id', 'tanggal', 'temperatur_avg', 'kelembaban_avg', 'kecepatan_angin_avg', 'jum_curah_hujan', 'jum_hari_hujan', 'penyinaran_matahari_avg'];
  _addData('cuaca', addCuacaForm, inputData);
}

//? Update Data
if (updateCuacaBtns.length > 0) {
  inputData = ['tanggal', 'temperatur_avg', 'kelembaban_avg', 'kecepatan_angin_avg', 'jum_curah_hujan', 'jum_hari_hujan', 'penyinaran_matahari_avg'];
...
if (clusteringResultTable) {
  var clusteringResultTableOptions = {
    perPage: 10,
    columns: [{
      select: 0,
      type: 'date',
...
if (addClusteringForm) {
  addClusteringForm.addEventListener('submit', function (e) {
    ...
    if (addClusteringForm.checkValidity()) {
      var user_id = addClusteringForm.querySelector('#add-user_id').value;
      var jum_cluster = addClusteringForm.querySelector('#add-jum_cluster').value;
      var checkboxes = addClusteringForm.querySelectorAll('[id^="criteria"]');
      var selectedCheckboxes = [];
      checkboxes.forEach(function (el) {
        if (el.checked) selectedCheckboxes.push(el.value);
      });
      if (selectedCheckboxes.length > 0) {
        var kriteria_clustering = JSON.stringify(selectedCheckboxes);
        var dataObj = {
