...
exports.showAlert = exports.hideAlert = exports.delayAlert = void 0;
/* eslint-disable */
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"manage-user.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var addNewUser = exports.addNewUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userObj, form, modal) {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            modal.hide();
            (0, _alert.delayAlert)("User ".concat(userResult.fullname, " has been added successfully"), 'success');
          }
          _context.next = 12;
          break;
        case 7:
          ...
          _context.t0 = _context["catch"](0);
          form.classList.remove('was-validated');
          arrValidationError = _context.t0.response.data.validationError;
          arrValidationError.forEach(function (el) {
            (0, _alert.showAlert)("".concat(_context.t0.response.data.message, ": <span class='fw-bold'>").concat(el.message, "</span>"), 'danger');
          });
        case 12:
        case "end":
          return _context.stop();
  ...
  return function addNewUser(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"manage-dataset.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var addNewDataset = exports.addNewDataset = /*#__PURE__*/function () {
...
var _manageUser = require("./manage-user");
var _manageDataset = require("./manage-dataset");
var _alert = require("./alert");
/* eslint-disable */
