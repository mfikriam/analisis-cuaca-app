...
var delUserById = exports.delUserById = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(Modals, userId) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          try {
            ...
            (0, _alert.showAlert)(err.response.data.message, 'danger');
          }
        case 1:
        case "end":
          return _context.stop();
  ...
  return function delUserById(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
if (userTable) {
  ...
  var dataTable = new _simpleDatatables.DataTable(userTable, optios);
}
if (delUserBtns.length > 0) {
  ...
  delUserBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      (0, _manageUser.delUserById)(bsModalList, userId);
    });
  });
}
